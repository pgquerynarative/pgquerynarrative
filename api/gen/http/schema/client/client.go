...
// Client lists the schema service endpoint HTTP clients.
type Client struct {
...
// NewClient instantiates HTTP clients for all the schema service servers.
func NewClient(
	scheme string,
	host string,
	doer goahttp.Doer,
...
// Get returns an endpoint that makes HTTP requests to the schema service get
// server.
func (c *Client) Get() goa.Endpoint {
	...
	return func(ctx context.Context, v any) (any, error) {
		...
		if err != nil {
			return nil, goahttp.ErrRequestError("schema", "get", err)
		}
