...
var AnomalyPointData = Type("AnomalyPointData", func() {
	...
	Attribute("explanation", String, "One-sentence interpretation of why this point looks anomalous")
...
var TrendSummaryData = Type("TrendSummaryData", func() {
	...
	Attribute("explanation", String, "One-sentence interpretation of what this trend suggests")
